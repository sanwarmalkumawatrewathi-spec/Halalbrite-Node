  ...
  return (
    ...
    >
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20 relative' style={{
        ...
        {/* Content */}
        <div className="text-center max-w-3xl mx-auto relative z-10 flex flex-col items-center">
          <h1 className="mb-6 text-white text-3xl sm:text-4xl lg:text-5xl font-bold">
            Discover. Host. Connect.
          </h1>

          <p className="text-white max-w-2xl mx-auto text-[22px] font-bold mx-[48px] mt-[0px] mb-[32px]">
            Your hub for events that respect your values and build <br></br> h community.
          </p>
