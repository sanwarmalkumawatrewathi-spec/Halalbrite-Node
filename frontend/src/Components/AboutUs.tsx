      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 relative z-10">
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl mb-8">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="/events" className="inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive h-10 has-[>svg]:px-4 border-2 border-white bg-transparent text-white hover:bg-white hover:text-red-600 rounded-xl px-6 sm:px-8 text-sm sm:text-base">
              Browse Events
            </a>
          </div>
        </div>
