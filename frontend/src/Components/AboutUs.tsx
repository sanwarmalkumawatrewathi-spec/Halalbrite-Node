    ...
    <main className="flex-1 w-full bg-gray-50 pb-20">
      ...
      <div className="bg-gradient-to-br from-red-500 to-red-600 text-white py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="mb-4 sm:mb-6 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">About Halalbrite</h1>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 text-center flex flex-col items-center">
            <div className="w-14 h-14 bg-red-50 rounded-full flex items-center justify-center mb-6 text-red-600 border border-red-100">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
            </div>
            <h4 className="text-lg font-bold text-gray-900 mb-3">Halal-Compliant</h4>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 text-center flex flex-col items-center">
            ...
            <h4 className="text-lg font-bold text-gray-900 mb-3">Easy to Use</h4>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 text-center flex flex-col items-center">
            ...
            <h4 className="text-lg font-bold text-gray-900 mb-3">Ecosystem</h4>
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl mb-8">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="/post-an-event" className="bg-white text-red-600 font-[500] py-3 px-8 rounded-[8px] shadow-lg hover:bg-gray-50 transition transform hover:-translate-y-1">
              Create Your First Event
            </a>
            <a href="/events" className="bg-white text-red-500 hover:text-white font-[500] py-3 px-8 rounded-full shadow-lg border-1 border-white hover:bg-transparent transition transform hover:-translate-y-1">
              Browse Events
            </a>
          </div>
        </div>
