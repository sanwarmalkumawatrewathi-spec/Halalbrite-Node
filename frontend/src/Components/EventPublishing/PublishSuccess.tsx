...
export default function PublishSuccess({ eventId, slug, eventName }: PublishSuccessProps) {
  return (
    <div className="fixed inset-0 z-[120] bg-[#fafafa] overflow-y-auto flex flex-col min-h-screen">
      <div className="flex-grow flex items-center justify-center p-4 py-8 sm:py-12">
        <div className="bg-white rounded-[2.5rem] w-full max-w-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-500 my-4">
          <div className="bg-red-600 p-12 text-center text-white relative">
            <div className="w-24 h-24 bg-white rounded-3xl flex items-center justify-center mx-auto mb-6 p-3 shadow-md">
              <img src="/images/logo.png" alt="Halalbrite Logo" className="w-full h-full object-contain" />
            </div>
            <h2 className="text-4xl font-black mb-2 tracking-tight">Mabrook!</h2>
          ...
          <div className="p-10 space-y-10">
            <div className="text-center space-y-3">
              <h3 className="text-xl font-bold text-gray-900 italic">
                {eventName || "Your Event"} <span className="text-gray-500 font-medium not-italic">has been successfully published!</span>
              </h3>
