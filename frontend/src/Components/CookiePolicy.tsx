          ...
          <div className="[&_:last-child]:pb-6 p-5 sm:p-6 md:p-8">
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed text-sm sm:text-base">
              <div className="grid gap-4">
                {[
                  { name: "localStorage — token", desc: "Stores your Halalbrite API authentication token so you remain signed in.", retention: "Cleared when you sign out or manually clear browser storage." },
                  { name: "localStorage — Halalbrite_user", desc: "Stores your user profile details to ensure a seamless experience without unnecessary reloading.", retention: "Cleared when you sign out or manually clear browser storage." },
                  { name: "localStorage — event_form_draft", desc: "Temporarily holds drafted event details while you move between creation screens or refresh the page.", retention: "Removed when you submit the event or discard the draft." },
                  { name: "localStorage — event_tickets_draft", desc: "Temporarily holds drafted event ticket details during the creation process.", retention: "Removed when you submit the event or discard the draft." },
