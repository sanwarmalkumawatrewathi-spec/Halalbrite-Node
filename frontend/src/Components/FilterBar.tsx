        ...
        <div className="flex flex-col md:flex-row items-center gap-4 p-6 bg-white">
          <div className="relative flex-1 group w-full">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-transparent rounded-xl outline-none focus:ring-2 focus:ring-red-500/20 focus:bg-white focus:border-red-500 transition-all text-sm font-medium"
