  ...
  return (
    <div className="space-y-6" suppressHydrationWarning>
      <div className="grid gap-4 sm:gap-6 md:grid-cols-3">
        {/* Profile Photo Card */}
        <div data-slot="card" className="bg-white text-gray-900 flex flex-col gap-6 rounded-xl border border-gray-200 md:col-span-1 shadow-sm">
          <div data-slot="card-header" className="grid auto-rows-min grid-rows-[auto_auto] items-start gap-1.5 p-4 sm:p-6 pb-0">
            <h4 data-slot="card-title" className="text-lg sm:text-xl font-semibold">Profile Photo</h4>
          </div>
          <div data-slot="card-content" className="flex flex-col items-center p-4 sm:p-6 pt-0">
        ...
        <div data-slot="card" className="bg-white text-gray-900 flex flex-col gap-6 rounded-xl border border-gray-200 md:col-span-2 shadow-sm">
          <div data-slot="card-header" className="grid auto-rows-min grid-rows-[auto_auto] items-start gap-1.5 p-4 sm:p-6 pb-0">
            <h4 data-slot="card-title" className="text-lg sm:text-xl font-semibold">Personal Information</h4>
