  ...
  return (
    <div className="space-y-4 sm:space-y-6" suppressHydrationWarning>
      ...
      {!isOrganizer && (
        <div data-slot="card" className="text-gray-900 flex flex-col gap-6 rounded-xl border border-red-200 bg-gradient-to-br from-red-50 to-white shadow-sm">
          <div data-slot="card-header" className="grid auto-rows-min grid-rows-[auto_auto] items-start gap-1.5 p-4 sm:p-6 pb-0">
            <h4 data-slot="card-title" className="text-red-900 text-lg sm:text-xl font-semibold">Become an Event Organiser</h4>
      ...
      <div data-slot="card" className="bg-white text-gray-900 flex flex-col gap-6 rounded-xl border border-gray-200 shadow-sm">
        <div data-slot="card-header" className="grid auto-rows-min grid-rows-[auto_auto] items-start gap-1.5 p-4 sm:p-6 pb-0">
          <h4 data-slot="card-title" className="text-lg sm:text-xl font-semibold">Email Preferences</h4>
          <p data-slot="card-description" className="text-gray-500 text-sm">Manage your email notifications</p>
        </div>
        <div data-slot="card-content" className="space-y-3 sm:space-y-4 p-4 sm:p-6 pt-0">
      ...
      <div data-slot="card" className="bg-white text-gray-900 flex flex-col gap-6 rounded-xl border border-gray-200 shadow-sm">
        <div data-slot="card-header" className="grid auto-rows-min grid-rows-[auto_auto] items-start gap-1.5 p-3 sm:p-4 pb-0">
          <h4 data-slot="card-title" className="text-lg sm:text-xl font-semibold flex items-center gap-2">
      ...
      <div data-slot="card" className="bg-white text-gray-900 flex flex-col gap-6 rounded-xl border border-red-200 shadow-sm">
        <div data-slot="card-header" className="grid auto-rows-min grid-rows-[auto_auto] items-start gap-1.5 p-4 sm:p-6 pb-0">
          <h4 data-slot="card-title" className="text-red-700 text-lg sm:text-xl font-semibold">Danger Zone</h4>
